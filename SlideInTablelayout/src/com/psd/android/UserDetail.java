...
public class UserDetail extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = db.rawQuery("SELECT emp._id, emp.firstName, emp.lastName, emp.title, emp.officePhone, emp.cellPhone, emp.email, emp.managerId, mgr.firstName managerFirstName, mgr.lastName managerLastName FROM game4user emp LEFT OUTER JOIN game4user mgr ON emp.managerId = mgr._id WHERE emp._id = ?", 
