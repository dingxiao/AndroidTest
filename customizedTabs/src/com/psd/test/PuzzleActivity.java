...
public class PuzzleActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		myGallery.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			*/
		     private Animation grow = AnimationUtils.loadAnimation(PuzzleActivity.this, R.anim.grow);
		     private int last = currentPos;

		     public void  Select() {
		        grow = AnimationUtils.loadAnimation(PuzzleActivity.this, R.anim.grow);
		        last = 0;
		     }
		...
		gameGallery.setOnItemSelectedListener(new OnItemSelectedListener() {
			   ...
			   public void  onItemSelected  (AdapterView<?>  parent, View  v, int position, long id) {
		            Toast.makeText(PuzzleActivity.this, "This is game " + position, Toast.LENGTH_SHORT).show();
			    }
